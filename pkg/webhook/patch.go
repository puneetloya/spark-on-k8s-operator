...
func patchSparkPod(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addOwnerReference(pod *corev1.Pod, app *v1alpha1.SparkApplication) patchOperation {
...
func addVolumes(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addSparkConfigMap(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
	var patchOps []patchOperation
...
func addHadoopConfigMap(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
	var patchOps []patchOperation
...
func addGeneralConfigMaps(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
	var configMaps []v1alpha1.NamePath
	if util.IsDriverPod(pod) {
...
// func addPrometheusConfigMap(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addAffinity(pod *corev1.Pod, app *v1alpha1.SparkApplication) *patchOperation {
...
func addTolerations(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addNodeSelectors(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addDNSConfig(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addSchedulerName(pod *corev1.Pod, app *v1alpha1.SparkApplication) *patchOperation {
...
func addSecurityContext(pod *corev1.Pod, app *v1alpha1.SparkApplication) *patchOperation {
...
func addSidecarContainers(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
...
func addPodLifeCycleConfig(pod *corev1.Pod, app *v1alpha1.SparkApplication) *patchOperation {
...
// func addGPU(pod *corev1.Pod, app *v1alpha1.SparkApplication) *patchOperation {
...
func addHostNetwork(pod *corev1.Pod, app *v1alpha1.SparkApplication) []patchOperation {
